...
router.post('/nuevo-usuario', protegerRuta, body("nombre").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                            body("apellido").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                            body("correo").isEmail().notEmpty().withMessage("correo no invalido"),
                                            body("cargo").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                            body("tipo").notEmpty().escape().withMessage("Seleccione un tipo de usuario"),
                                            body("departamento").notEmpty().escape().withMessage("Seleccione un departamento"),
                                            registrarUsuario)
                                            
router.get('/usuarios', protegerRuta, usuarios)

router.get('/editar-usuario/:id', protegerRuta, editarUsuario)
router.post('/editar-usuario/:id', protegerRuta, body("nombre").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                                 body("apellido").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                                 body("correo").isEmail().escape().notEmpty().withMessage("correo no invalido"),
                                                 body("cargo").notEmpty().escape().withMessage("No se permiten valores vacios"),
                                                 body("tipo").notEmpty().escape().withMessage("Seleccione un tipo de usuario"),
                                                 body("departamento").notEmpty().escape().withMessage("Seleccione un departamento"), guardarUsuario)

router.post('/eliminar-usuario/:id', protegerRuta, eliminarUsuario)

router.get('/crear-aviso', protegerRuta, crearAviso)
router.post('/crear-aviso', protegerRuta, body("titulo").notEmpty().escape().withMessage("Debe escribir un titulo"),
                                          body("mensaje").notEmpty().escape().withMessage("Debe escribir un mensaje"),
                                          body("destino").notEmpty().escape().withMessage("Seleccione a quien envia el mensaje"),enviarAviso)
