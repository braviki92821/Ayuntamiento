...
router.post('/crear-solicitud', protegerRuta, body('titulo').notEmpty().escape().withMessage('Debe agregar un titulo a su solicitud'),
                                body('tipoRecurso').notEmpty().escape().withMessage('Seleccione el tipo de recurso a solicitar'),
